      ...
      <div class="panel-body">
        <table class="table table-borderless table-hover table-files table-fixed no-margin">
          ...
          <tbody>
            ...
            <tr>
              <td class="c-name"><span class="label label-id"><?php echo $doc->id;?></span><?php echo html::a(inlink('view', "docID=$doc->id"), "<i class='icon icon-file-text text-muted'></i> &nbsp;" . $doc->title);?></td>
